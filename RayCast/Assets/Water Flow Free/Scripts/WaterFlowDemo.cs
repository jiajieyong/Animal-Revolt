...
public class WaterFlowDemo : MonoBehaviour
{
	...
	void Start ()
	{
		...
		foreach(Transform child in transform)
		{
			...
			switch(m_WaterList[i].gameObject.renderer.material.shader.name)
			{

				case "Water Flow/Water Diffuse":

					m_WaterDiffuseOriginal_Diffuse 		= m_WaterList[i].gameObject.renderer.material.GetColor("_MainTexColor");
					m_WaterDiffuseOriginal_Multiply 	= m_WaterList[i].gameObject.renderer.material.GetFloat("_MainTexMultiply");
					m_WaterDiffuseOriginal_UMoveSpeed 	= m_WaterList[i].gameObject.renderer.material.GetFloat("_MainTexMoveSpeedU");
					m_WaterDiffuseOriginal_VMoveSpeed 	= m_WaterList[i].gameObject.renderer.material.GetFloat("_MainTexMoveSpeedV");
				...
				case "Water Flow/Water Heightmap":
					...
					m_WaterHeightmapOriginal_WaterTile 			= m_WaterList[i].gameObject.renderer.material.GetFloat("_MainTexTile");
					m_WaterHeightmapOriginal_HeightmapTile 		= m_WaterList[i].gameObject.renderer.material.GetFloat("_HeightMapTile");
					m_WaterHeightmapOriginal_Refraction 		= m_WaterList[i].gameObject.renderer.material.GetFloat("_MainTexRefraction");
					m_WaterHeightmapOriginal_Strength 			= m_WaterList[i].gameObject.renderer.material.GetFloat("_HeightMapStrength");
					m_WaterHeightmapOriginal_Multiply 			= m_WaterList[i].gameObject.renderer.material.GetFloat("_HeightMapMultiply");
				...
				case "Water Flow/Water Simple":
					...
					m_WaterSimpleOriginal_UMoveSpeed 	= m_WaterList[i].gameObject.renderer.material.GetFloat("_MainTexMoveSpeedU");
					m_WaterSimpleOriginal_VMoveSpeed 	= m_WaterList[i].gameObject.renderer.material.GetFloat("_MainTexMoveSpeedV");
	...
	void ShaderGUIWindow()
	{
		...
		{
			GUI.Window(3, new Rect(0, 0, 300, 240), WaterDiffuseGUIWindow, m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.shader.name.Replace("Water Flow/","Shader: "));
		}
		// Show Water Heightmap GUI window
		else if(m_CurrentWaterShaderType == eWaterShaderType.WaterHeightmap)
		{
			GUI.Window(4, new Rect(0, 0, 300, 240), WaterHeightmapGUIWindow, m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.shader.name.Replace("Water Flow/","Shader: "));
		}
		// Show Water Simple GUI window
		else if(m_CurrentWaterShaderType == eWaterShaderType.WaterSimple)
		{
			GUI.Window(5, new Rect(0, 0, 300, 240), WaterSimpleGUIWindow, m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.shader.name.Replace("Water Flow/","Shader: "));
		}
	}
	...
	void WaterDiffuseGUIWindow(int id)
	{
		...
		if(m_WaterDiffuseOld_Diffuse != m_WaterDiffuse_Diffuse)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetColor("_MainTexColor", m_WaterDiffuse_Diffuse);
		}
		...
		if(m_WaterDiffuseOld_Multiply != m_WaterDiffuse_Multiply)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMultiply", m_WaterDiffuse_Multiply);
		...
		if(m_WaterDiffuseOld_UMoveSpeed != m_WaterDiffuse_UMoveSpeed)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMoveSpeedU", m_WaterDiffuse_UMoveSpeed);
		}
		...
		if(m_WaterDiffuseOld_VMoveSpeed != m_WaterDiffuse_VMoveSpeed)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMoveSpeedV", m_WaterDiffuse_VMoveSpeed);
		}
		...
		if(GUI.Button( new Rect(125, 200, 150, 30), "Reset"))
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetColor("_MainTexColor", m_WaterDiffuseOriginal_Diffuse);
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMultiply", m_WaterDiffuseOriginal_Multiply);
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMoveSpeedU", m_WaterDiffuseOriginal_UMoveSpeed);
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMoveSpeedV", m_WaterDiffuseOriginal_VMoveSpeed);
	...
	{        
		...
		if(m_WaterHeightmapOld_WaterTile != m_WaterHeightmap_WaterTile)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexTile", m_WaterHeightmap_WaterTile);            
		}
		...
		if(GUI.Button( new Rect(245, 55, 20, 22), "<"))
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetTexture("_HeightMap1", m_HeightMapTextures[m_WaterHeightMap1Index]);
		}
		...
		if(GUI.Button( new Rect(245, 75, 20, 22), "<"))
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetTexture("_HeightMap2", m_HeightMapTextures[m_WaterHeightMap2Index]);
		}
		...
		if(m_WaterHeightmapOld_HeightmapTile != m_WaterHeightmap_HeightmapTile)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_HeightMapTile", m_WaterHeightmap_HeightmapTile);
		...
		if(m_WaterHeightmapOld_Refraction != m_WaterHeightmap_Refraction)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexRefraction", m_WaterHeightmap_Refraction);
		...
		if(m_WaterHeightmapOld_Strength != m_WaterHeightmap_Strength)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_HeightMapStrength", m_WaterHeightmap_Strength);
		}
		...
		if(m_WaterHeightmapOld_Multiply != m_WaterHeightmap_Multiply)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_HeightMapMultiply", m_WaterHeightmap_Multiply);
		}
		...
		{
			// Load Original shader values
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexTile", m_WaterHeightmapOriginal_WaterTile);
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_HeightMapTile", m_WaterHeightmapOriginal_HeightmapTile);
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexRefraction", m_WaterHeightmapOriginal_Refraction);
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_HeightMapStrength", m_WaterHeightmapOriginal_Strength);
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_HeightMapMultiply", m_WaterHeightmapOriginal_Multiply);
	...
	void WaterSimpleGUIWindow(int id)
	{
		...
		if(m_WaterSimpleOld_UMoveSpeed != m_WaterSimple_UMoveSpeed)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMoveSpeedU", m_WaterSimple_UMoveSpeed);
		}
		...
		if(m_WaterSimpleOld_VMoveSpeed != m_WaterSimple_VMoveSpeed)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMoveSpeedV", m_WaterSimple_VMoveSpeed);
		}
		...
		if(GUI.Button( new Rect(125, 175, 150, 30), "Reset"))
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMoveSpeedU", m_WaterSimpleOriginal_UMoveSpeed);
			m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.SetFloat("_MainTexMoveSpeedV", m_WaterSimpleOriginal_VMoveSpeed);
	...
	void UpdateCurrentShaderType()
	{
		...
		if(m_WaterList[m_CurrentWaterIndex].gameObject.renderer==null)
			return;
		if(m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material==null)
			return;

		switch(m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.shader.name)
		{
			...
			case "Water Flow/Water Diffuse":
				...
				m_WaterDiffuse_Diffuse 				= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetColor("_MainTexColor");
				m_WaterDiffuse_Multiply 			= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_MainTexMultiply");
				m_WaterDiffuse_UMoveSpeed 			= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_MainTexMoveSpeedU");
				m_WaterDiffuse_VMoveSpeed 			= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_MainTexMoveSpeedV");
			...
			case "Water Flow/Water Heightmap":
				...
				Texture txHeightMap1 = m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetTexture("_HeightMap1");
				Texture txHeightMap2 = m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetTexture("_HeightMap2");
				...
				m_WaterHeightmap_WaterTile 			= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_MainTexTile");
				m_WaterHeightmap_HeightmapTile 		= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_HeightMapTile");
				m_WaterHeightmap_Refraction 		= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_MainTexRefraction");
				m_WaterHeightmap_Strength 			= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_HeightMapStrength");
				m_WaterHeightmap_Multiply 			= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_HeightMapMultiply");
			...
			case "Water Flow/Water Simple":
				...
				m_WaterSimple_UMoveSpeed 			= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_MainTexMoveSpeedU");
				m_WaterSimple_VMoveSpeed 			= m_WaterList[m_CurrentWaterIndex].gameObject.renderer.material.GetFloat("_MainTexMoveSpeedV");
